...
import UserManageMain from '@/components/main/UserManageMain.vue'
import { ref } from 'vue'
...
<template>
  <BaseView inside :title="$t('authorityManagement')">
    <template v-slot:breadcrumb>
      ...
      <el-breadcrumb :separator-icon="ArrowRight" v-else>
        ...
        <el-breadcrumb-item :to="{ path: `/user/${$route.params.id}/manage` }">
